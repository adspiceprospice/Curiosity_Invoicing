...
export default function NewInvoice({ customers, templates }: NewInvoiceProps) {
  ...
  return (
    <>
      <Head>
        <title>{t('invoices.new')} | Curiosity Invoicing</title>
      </Head>

      <DashboardLayout>
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">{t('invoices.new')}</h1>
