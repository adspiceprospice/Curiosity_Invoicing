...
export default function EditOffer({ offer, customers, templates }: EditOfferProps) {
  ...
  if (offer.status !== 'DRAFT') {
    return (
      <>
        <Head>
          <title>{t('offers.edit')} | Curiosity Invoicing</title>
        </Head>

        <DashboardLayout>
          <div className="mb-6">
            <h1 className="text-2xl font-semibold text-gray-900">{t('offers.edit')}</h1>
          </div>
